...
public class PermissionUtils {
    ...
    /**
     * Requests java.permission.
     *
     * @param activity
     * @param requestCode request code, e.g. if you need request CAMERA java.permission,parameters is PermissionUtils.CODE_CAMERA
     */
...
//        }
        ...
        try {
            ...
            Toast.makeText(activity, "please open this java.permission", Toast.LENGTH_SHORT)
                    .show();
    ...
    private static void requestMultiResult(Activity activity, String[] permissions, int[] grantResults, PermissionGrant permissionGrant) {
        ...
        if (notGranted.size() == 0) {
            Toast.makeText(activity, "all java.permission success" + notGranted, Toast.LENGTH_SHORT)
                    .show();
            permissionGrant.onPermissionGranted(CODE_MULTI_PERMISSION);
        } else {
            openSettingActivity(activity, "those java.permission need granted!");
        }
    ...
    public static void requestMultiPermissions(final Activity activity, PermissionGrant grant) {
        ...
        if (permissionsList.size() > 0) {
            ...
            showMessageOKCancel(activity, "should open those java.permission",
    ...
    public static void requestPermissionsResult(final Activity activity, final int requestCode, @NonNull String[] permissions,
        ...
        if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            //TODO hint user this java.permission function
    ...
    public static ArrayList<String> getNoGrantedPermission(Activity activity, boolean isShouldRationale) {
        ...
        for (int i = 0; i < requestPermissions.length; i++) {
            ...
            try {
                ...
                Toast.makeText(activity, "please open those java.permission", Toast.LENGTH_SHORT)
                        .show();
                Log.e(TAG, "RuntimeException:" + e.getMessage());
                return null;
            }
